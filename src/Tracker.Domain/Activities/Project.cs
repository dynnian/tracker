namespace Tracker.Domain.Activities
{
    ...
    public sealed class Project
    {
        ...
        // A list of tags associated with the project. eg Completed, In Progress, etc.
            ...
            DateTime? endDate = null)
        {
            ...
            OwnerUserId = !string.IsNullOrWhiteSpace(owner)
                ? owner
                : throw new ArgumentNullException(nameof(owner), "Owner cannot be empty.");
